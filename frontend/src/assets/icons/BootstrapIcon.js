...
const BootstrapIcon = props => {
	...
	const Plug = (
		<svg width={size || "1em"} height={size || "1em"} viewBox="0 0 16 16" className="bi bi-outlet" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
			...
			<path fillRule="evenodd" d="M6 5.5a.5.5 0 0 1 .5.5v1.5a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5zm4 0a.5.5 0 0 1 .5.5v1.5a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5z"/>
